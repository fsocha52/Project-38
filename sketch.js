...
function preload() {
  ...
  runningAnimation = loadAnimation("run01.png", "run02.png", "run03.png", "run04.png", "run05.png", "run06.png", "run07.png", "run08.png", "run09.png");
  
  
  
  gameBackground = loadImage("defaultBackground.png");
  platformBackground = loadImage("defaultPlatform.png");
